...
image::https://raw.githubusercontent.com/aarre/drawl/master/docs/images/arrowheads-graphviz.png[Graphviz arrowheads,250,350]
...
image::https://raw.githubusercontent.com/aarre/drawl/master/docs/images/arrowheads-pstricks.png[Arrowheads in PSTricks,250,350]
