...
class DrawingTest extends Specification {
    ...
    def "When a square (100) drawing has two adjacent Circles, then the SVG is correct"() {
        ...
        then:
        svg.equals("<?xml version=\"1.0\" standalone=\"no\"?><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"100\" height=\"100\"><circle r=\"25\" cx=\"25\" cy=\"50\" /><circle r=\"25\" cx=\"75\" cy=\"50\" /></svg>")
    }
    ...
    def "When a square (200) drawing has two adjacent Circles, then the SVG is correct"() {
        ...
        then:
        svg.equals("<?xml version=\"1.0\" standalone=\"no\"?><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"200\" height=\"200\"><circle r=\"50\" cx=\"50\" cy=\"100\" /><circle r=\"50\" cx=\"150\" cy=\"100\" /></svg>")
    }
